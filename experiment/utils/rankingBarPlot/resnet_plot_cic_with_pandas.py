...
data = pd.read_excel(file_path, sheet_name='resnet_csv2')
#data = data.round(2)
...
ax.set_title('ResNet18 Models Ranking on Adversarial Tests', fontsize=16)
...
#, fontsize='small'
# Show the plot
plt.legend(loc='upper left', ncol=2, fontsize=11.5)
plt.ylim(0,57)
fig = plt.gcf()
...
fig.savefig("ranking_resnet.png")
plt.close(fig)
