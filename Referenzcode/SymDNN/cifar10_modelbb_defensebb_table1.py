...
if __name__ == '__main__':
    ...
    atks = [
        ...
        FAB(net_holdout, eps=4/255, steps=100, n_classes=10, n_restarts=1),
        ...
        FAB(net_holdout, eps=8/255, steps=100, n_classes=10, n_restarts=1),
        ...
        FAB(net_holdout, eps=16/255, steps=100, n_classes=10, n_restarts=1),
