...
if __name__ == '__main__':
    ...
    print(grid_inputs.shape)
    print(grid_outputs.shape)
    ...
    # atk = PGD(model, eps=20/255, alpha=5/225, steps=20, random_start=True)
    # print(atk)
    # atk.set_mode_targeted_by_function(target_map_function=lambda images, idx:(idx+1)%3)
