...
class PatternMatcher:
    ...
    #             futures = [executor.submit(self._choose_best_pattern, single_tensor) for tensor in layer for single_tensor in tensor]
    #             for future in futures:
    #                 temp_layer.append(future.result())
...
# Assuming `layer` is a list of tensors
layer = [torch.randn(256,384,3, 3) for _ in range(2)]  # Example layer with random tensors
...
# for i in range(len(normal_processed_layer)):
#     print("Multi:")
#     print(processed_layer)
#     print("Normal Processed:")
#     print(normal_processed_layer)
