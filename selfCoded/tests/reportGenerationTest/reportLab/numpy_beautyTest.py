...
if __name__ == "__main__":
    array_3d = np.random.randn(2)
    array_4d = np.random.randn(2, 4, 3, 3)

    print(NumpyArrayFormatter.format_array(array_3d))
    print(NumpyArrayFormatter.format_array(array_4d))
